...
export const CHORDS = {
  ...
  ii:    { tones: [T(2), T(4), T(6)], bass: 2, label: 'ii',    html: 'ii',                      fn: 'pre-dominant' },
  ii6:   { tones: [T(2), T(4), T(6)], bass: 4, label: 'ii6',   html: 'ii<sup>6</sup>',          fn: 'pre-dominant' },
  ii7:   { tones: [T(2), T(4), T(6), T(1)], bass: 2, label: 'ii7', html: 'ii<sup>7</sup>',      fn: 'pre-dominant' },
  ii65:  { tones: [T(2), T(4), T(6), T(1)], bass: 4, label: 'ii6/5', html: 'ii<sup>6</sup><sub>5</sub>', fn: 'pre-dominant' },
  IV:    { tones: [T(4), T(6), T(1)], bass: 4, label: 'IV',    html: 'IV',                      fn: 'pre-dominant' },
  IV6:   { tones: [T(4), T(6), T(1)], bass: 6, label: 'IV6',   html: 'IV<sup>6</sup>',          fn: 'pre-dominant' },
  iv:    { tones: [T(4), T(6, -1), T(1)], bass: 4, label: 'iv', html: 'iv',                     fn: 'borrowed pre-dominant' },
